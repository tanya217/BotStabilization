 ...
 while(1){
  i = Serial.read();
   ...
   if(i == 49){
    ...
    delay(ACTIME);
    Serial.println("lifting 1st set");
    }
    if(i == 50){
    temp_act[2]=1;
    temp_act[3]=1;
    liftMultiple(temp_act);
    delay(ACTIME);
    Serial.println("lifting 2nd set");
    }
    if(i == 51){
    temp_act[4]=1;
    temp_act[5]=1;
    liftMultiple(temp_act);
    delay(ACTIME);
    Serial.println("lifting 3rds set");
    }
    if(i == 52){
    temp_act[0]=0;
    temp_act[1]=0;
